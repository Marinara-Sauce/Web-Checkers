...
<body>
            ...
            <div>
              <table data-color='RED'>
                <tr>
                  ...
                  <td class="name">Red</td> <td class="rating"></td><td class="win"></td><td class="lose"></td>
                </tr>
              </table>
              <table data-color='WHITE'>
                <tr>
                  <td><img src="../img/single-piece-white.svg" /></td>
                  <td class="name">White</td> <td class="rating"></td></td><td class="win"></td><td class="lose"></td>
                </tr>
              </table>
            </div>
          </fieldset>
  ...
  <audio id="audio" src="/img/beep.mp3" autostart="false" ></audio>
