...
define(function(require){
  ...
  function GameState(gameData) {
    ...
    /**
     * Get the rating of the RED Player in this game.
     */
    this.getRedRating = function getRedRating() {
      return gameData.redRating;
    };

    /**
     * Get the rating of the WHITE Player in this game.
     */
    this.getWhiteRating = function getWhiteRating() {
      return gameData.whiteRating;
    };
