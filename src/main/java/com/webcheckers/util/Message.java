...
public final class Message {
   ...
   *
   * NOTE: This constructor was private at first, I made it public
   * I have 0 clue why it was private, but there was probably a good
   * reason. So if things break, this may be why...
   * 
   * @param message  the text of the message
